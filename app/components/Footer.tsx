...
const quickLinks = [
  ...
  { href: '#write-review', label: 'Write Review' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,200px),1fr))', gap: '2.5rem 2rem', marginBottom: '2.5rem' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                {quickLinks.map(l => (
                  <li key={l.href}>
                    <a href={l.href} style={{ color: 'rgba(255,255,255,0.38)', fontSize: '0.875rem', fontWeight: 500, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.375rem', transition: 'color 0.2s' }}
