...
const WA  = 'https://wa.me/2348094946923?text=Hi%20Chizzychops%20%26%20Grillz!%20I%27d%20like%20to%20get%20in%20touch%20%F0%9F%8D%BD%EF%B8%8F'
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.9375rem', maxWidth: '30rem', margin: '0 auto', lineHeight: 1.75 }}>
            We&apos;re an online home kitchen — reach us via WhatsApp or follow along on Instagram.
            No queues, no waiting rooms. Just great food, delivered to you.
          </p>
        </div>

        {/* Info cards — 3 cards: WhatsApp, Hours, Instagram */}
          ...
          {[
            {
              ...
              label: 'Call / WhatsApp',
              lines: ['0809 494 6923'],
              sub: 'Fastest way to order or ask questions',
              action: { label: 'Chat on WhatsApp', href: WA },
            },
            {
              icon: <ClockIcon />,
              accent: '#FBBF24',
              label: 'Delivery Hours',
              lines: ['Mon – Sat: 6:00 AM – 8:00 PM', 'Sunday: 12:00 PM – 6:00 PM'],
              sub: 'Orders placed outside hours processed next day',
              action: null,
            },
            {
              icon: <IGIconSvg />,
              ...
              label: 'Follow Us',
              lines: ['@chizzychops1'],
              sub: 'Tag us when you eat — we love seeing your faces!',
              action: { label: 'View Instagram', href: IG },
            },
          ].map(c => (
            <div key={c.label} className="card" style={{ padding: '1.5rem', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ width: '2.5rem', height: '2.5rem', borderRadius: '0.625rem', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem', background: `${c.accent}18`, color: c.accent, border: `1px solid ${c.accent}28`, flexShrink: 0 }}>
                {c.icon}
              </div>
              ...
              {c.action && (
                <a href={c.action.href} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '0.375rem', marginTop: '0.875rem', fontSize: '0.8125rem', fontWeight: 700, color: c.accent, textDecoration: 'none' }}>
                  {c.action.label} →
                </a>
              )}
            </div>
        ...
        <div style={{ borderRadius: '1rem', padding: '1.5rem', background: 'rgba(251,191,36,0.06)', border: '1px solid rgba(251,191,36,0.18)', display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: '14rem' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.875rem', lineHeight: 1.7 }}>
              We deliver all across Lagos. Since everything is freshly home-cooked to order,
              please allow <strong style={{ color: '#FBBF24' }}>up to 6 hours</strong> from the time we confirm your order.
              Your delivery address will be arranged directly via WhatsApp.
            </p>
          </div>
        ...
        {/* WhatsApp CTA */}
        <div style={{ borderRadius: '1.25rem', border: '1px solid rgba(37,211,102,0.2)', background: 'rgba(37,211,102,0.04)', overflow: 'hidden' }}>
          <div style={{ padding: '2rem', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start', marginBottom: '1.25rem', flexWrap: 'wrap' }}>
              <div style={{ width: '3rem', height: '3rem', borderRadius: '50%', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 0 20px rgba(37,211,102,0.35)' }}>
                <WAIconSvg size={20} />
              </div>
              <div style={{ flex: 1, minWidth: '12rem' }}>
                <p style={{ color: '#fff', fontFamily: 'var(--font-playfair)', fontWeight: 700, fontSize: '1.25rem', lineHeight: 1.2 }}>Chat with Us on WhatsApp</p>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', marginTop: '0.375rem' }}>
                  ...
                  <span style={{ color: '#4ADE80', fontSize: '0.8125rem', fontWeight: 600 }}>Usually replies within minutes</span>
                </div>
              </div>
            </div>
            <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.9375rem', lineHeight: 1.75, marginBottom: '1.25rem' }}>
              Fastest way to place an order, ask questions, or discuss event catering — we&apos;re always ready.
            </p>
            <p style={{ color: '#fff', fontWeight: 900, fontSize: '1.5rem', letterSpacing: '0.02em', marginBottom: '1.25rem', fontFamily: 'var(--font-playfair)' }}>0809 494 6923</p>
            <a href={WA} target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.625rem', width: '100%', padding: '1rem', borderRadius: '0.875rem', background: '#25D366', color: '#fff', fontWeight: 800, fontSize: '1.0625rem', textDecoration: 'none', boxShadow: '0 4px 20px rgba(37,211,102,0.3)', transition: 'background 0.2s' }}
              onMouseEnter={e => (e.currentTarget.style.background = '#1fba58')}
              onMouseLeave={e => (e.currentTarget.style.background = '#25D366')}>
              <WAIconSvg size={20} /> Start WhatsApp Chat
            </a>
          </div>
          ...
          <div style={{ padding: '1.25rem 2rem' }}>
            <a href={IG} target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', padding: '0.875rem 1rem', borderRadius: '0.875rem', background: 'rgba(225,48,108,0.08)', border: '1px solid rgba(225,48,108,0.2)', textDecoration: 'none', transition: 'background 0.2s' }}
...
function IGIconSvg() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="#E1306C"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
}